...
#   1. Take the input generated from pdf_to_text_converter.py
#   2. Generate the Extractive SUmmary and store in a text file
...
#This file will store the top ranked sentences
