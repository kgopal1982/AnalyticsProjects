...
#This file will do the following processing:
#   1. Take the pdf file as input
#   2. Convert each page of the pdf file into a jpg file
#   3. Extract text from each of the jpg file and store the final output in a text file
#   #sequence is pdf_to_text_converter.py, ExtractiveSummary.py, Translator.py
